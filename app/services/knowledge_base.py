...
DEFAULT_KB: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "answer": (
            "Кроме ArbitroPLEX существует несколько партнёрских проектов, в которых работает утилити-токен PLEX."
        ),
    ...
    # === АТОМАРНЫЙ АРБИТРАЖ ===
    {
        ...
        "clarification": ("НЕ торгуем между разными биржами! Только разница цен между пулами V2 и V3 на PancakeSwap."),
        "added_by": "system",
        "verified_by_boss": True,
    },
    {
        ...
        "clarification": ("Это создаёт постоянную циркуляцию монеты и поддерживает экономику."),
        "added_by": "system",
        "verified_by_boss": True,
    },
    {
    ...
    # === СЕССИЯ И ТАЙМАУТЫ ===
    {
        ...
        "clarification": (
            "Каждая авторизация стоит 10 PLEX. Так работает экономика платформы: плати PLEX = работай в системе."
        ),
        "added_by": "system",
        "verified_by_boss": True,
    },
    ...
    # === СХЕМА НАЧИСЛЕНИЯ ДОХОДА ===
    {
        ...
        "clarification": ("Ты видишь сколько бот заработал (100%), и получаешь свою долю по схеме выше."),
        "added_by": "system",
        "verified_by_boss": True,
    },
    # === ROI ===
    ...
    },
    {
        ...
        "clarification": (
            "Чтобы увеличить рабочую сумму — нужно сделать НОВЫЙ депозит. Для нового депозита нужны новые PLEX токены."
        ),
        "added_by": "system",
        "verified_by_boss": True,
    },
    # === ПРАВИЛА PLEX ===
    {
        ...
        "clarification": ("Заработанную прибыль можно вывести. Остальные суммы продолжают работать."),
        "added_by": "system",
        "verified_by_boss": True,
    },
    ...
    },
    {
        ...
        "answer": ("Главное меню → 👥 Рефералы → 🔗 Моя ссылка.\nКопируй и отправляй друзьям!"),
...
class KnowledgeBase:
    ...
    def add_entry(
        self, question: str, answer: str, category: str = "Общее", clarification: str = "", added_by: str = "admin"
    ) -> dict:
        entry = {
            "id": self.get_next_id(),
            "category": category,
