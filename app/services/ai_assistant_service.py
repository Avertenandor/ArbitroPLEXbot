...
1. Использовать tool `check_my_wallet` для проверки баланса пользователя
...
ДОСТУПНЫЕ TOOLS:
- `check_my_wallet` — проверить баланс кошелька (BNB, USDT, PLEX)
- `get_current_plex_rate` — узнать текущий курс PLEX
