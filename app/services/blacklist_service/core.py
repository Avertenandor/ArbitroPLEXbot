"""
Blacklist Service - Core Module.

Module: core.py
Contains basic blacklist operations: checking, adding, removing, and retrieving entries.
Handles blacklist entry management with reason tracking and admin logging.
"""
