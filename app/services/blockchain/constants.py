...
from app.config.constants import (
    ...
    BLOCKCHAIN_RETRY_DELAY_BASE,
    BLOCKCHAIN_WS_RECONNECT_DELAY,
    BLOCKCHAIN_WS_MAX_RECONNECT_ATTEMPTS,
)
...
RETRY_DELAY_BASE = BLOCKCHAIN_RETRY_DELAY_BASE

# WebSocket reconnect settings
WS_RECONNECT_DELAY = BLOCKCHAIN_WS_RECONNECT_DELAY
WS_MAX_RECONNECT_ATTEMPTS = BLOCKCHAIN_WS_MAX_RECONNECT_ATTEMPTS
