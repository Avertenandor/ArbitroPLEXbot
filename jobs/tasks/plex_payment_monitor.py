...
from app.models.plex_payment import PlexPaymentStatus
    ...
    for payment in warning_due:
        try:
            ...
            message = (
                ...
                f"📋 **Требуется:** {payment.daily_plex_required} PLEX в сутки\n\n"
                ...
                "Пожалуйста, оплатите PLEX для продолжения работы."
            )
