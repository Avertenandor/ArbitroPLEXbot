...
def _get_admin_capabilities_text(role: UserRole) -> str:
    ...
    return (
        ...
        "**6. Системные действия (только для Командира и доверенных админов)**\n"
        "• Управлять аварийными стопами (депозиты, выводы, ROI).\n"
        "• Менять некоторые настройки системы через специальные команды.\n\n"
        "**Важно про безопасность**\n"
        "• Опасные операции я выполняю только по командам из списка доверенных админов (security.py).\n"
