    ...
    if redis_client:
        ...
        if not await redis_client.exists(session_key):
            ...
            await message.answer(
                f"рџљЂ **Р”РѕР±СЂРѕ РїРѕР¶Р°Р»РѕРІР°С‚СЊ РІ ArbitroPLEXbot!**\n\n"
                f"РњС‹ СЃС‚СЂРѕРёРј **РєСЂРёРїС‚Рѕ-С„РёР°С‚РЅСѓСЋ СЌРєРѕСЃРёСЃС‚РµРјСѓ** РЅР° Р±Р°Р·Рµ РјРѕРЅРµС‚С‹ "
                f"**PLEX** Рё РІС‹СЃРѕРєРѕРґРѕС…РѕРґРЅС‹С… С‚РѕСЂРіРѕРІС‹С… СЂРѕР±РѕС‚РѕРІ.\n\n"
                f"рџ’Ћ **Р”РѕСЃС‚СѓРї Рє РЅР°С€РµР№ СЃРёСЃС‚РµРјРµ** РѕСЃСѓС‰РµСЃС‚РІР»СЏРµС‚СЃСЏ С‡РµСЂРµР· СЌС‚РѕРіРѕ Р±РѕС‚Р°.\n\n"
                f"рџ“Љ **Р”РѕС…РѕРґ:** РѕС‚ **30% РґРѕ 70%** РІ РґРµРЅСЊ!\n\n"
                f"рџ“‹ **РЈР РћР’РќР Р”РћРЎРўРЈРџРђ:**\n"
                f"```\n{LEVELS_TABLE}```\n"
                f"{RULES_SHORT_TEXT}\n\n"
                f"в”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓв”Ѓ\n"
                f"рџ”’ **РђР’РўРћР РР—РђР¦РРЇ**\n\n"
                f"Р”Р»СЏ РІС…РѕРґР° РІ СЃРёСЃС‚РµРјСѓ РЅРµРѕР±С…РѕРґРёРјРѕ:\n"
                f"1пёЏвѓЈ РЈРєР°Р·Р°С‚СЊ Р°РґСЂРµСЃ РІР°С€РµРіРѕ РєРѕС€РµР»СЊРєР°\n"
                f"2пёЏвѓЈ РћРїР»Р°С‚РёС‚СЊ 10 PLEX Р·Р° РґРѕСЃС‚СѓРї\n\n"
                f"рџ“ќ **Р’РІРµРґРёС‚Рµ Р°РґСЂРµСЃ РІР°С€РµРіРѕ BSC РєРѕС€РµР»СЊРєР°:**\n"
                f"_(Р¤РѕСЂРјР°С‚: 0x...)_",
